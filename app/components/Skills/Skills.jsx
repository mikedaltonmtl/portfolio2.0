...
const skillsText = [
  ...
  "With Express Server and Node.js at the back-end, I learned to use jQuery and the Bootstrap CSS framework. I studied SQL (which I loved!), relational databases and normalization, using the PostgreSQL database.",
  "Then came the big reveal, React! I guess there's a reason that it's become the go-to framework for web development. It really was a joy to learn and I quickly came to the conclusion that this was the tool I would like to work with in my career. It was no surprise when the group decided unanimously to use Next.js, Tailwind CSS, Prisma and PostgreSQL to build out our finals project.",
  "Throughout all of this, we used GitHub extensively, both individually and in the group projects.",
...
export default function Skills() {
  return (
    <section id="skills" className="pt-24 w-full flex pl-[3vw] flex-col">
